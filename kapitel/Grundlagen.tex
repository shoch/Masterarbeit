...
Im folgenden Kapitel werden die Grundlagen der Arbeit, insbesondere im Hinblick auf die gewählten Ansätze beschrieben. Begonnen wird mit den theoretischen Grundlagen, den Verwandten Arbeiten, gefolgt von einer Beschreibung der bestehenden Systeme, auf welche mit einem Abschnitt über die Daten und ihrer Vorverarbeitung abgeschlossen wird.
	...
	Für die Arbeit ist der \acl{cae} \cite{Masci.2011} kurz \ac{cae} interessant. Er ist ist ein Stacked Autoencoder, welcher Faltungsschichten (Convolutional Layer)  integriert. Faltungsschichten kommen von \cite{LeCun.1999} und haben sich durchgesetzt  https://papers.nips.cc/paper/4824-imagenet-classification-with-deep-convolutional-neural-networks.pdf
	https://static.googleusercontent.com/media/research.google.com/de//pubs/archive/43022.pdf
	https://doi.org/10.1038/nature14539
	
	
	  \todo{Convolutional Layer hier als Stand der Technik? CNN kommen von x haben sich durchgeserzt in 1,2,3,4,5}
	...
	Im traditionellen maschinellem Lernen wird pro Aufgabe und Datenset ein isoliertes Modell erstellt. Das Transferlernen hat das Ziel Wissen zu teilen. Die Isolation der Modelle soll aufgehoben werden. Dabei erfolgt eine Aufteilung in Quell- und Zieldomäne.
		...
		Insbesondere in https://arxiv.org/abs/1411.1792 ,https://papers.nips.cc/paper/6110-unsupervised-domain-adaptation-with-residual-transfer-networks und https://arxiv.org/pdf/1706.07446.pdf hat sich dieser Ansatz bewährt.
	...
	Learning to learn, pages 95–133. Springer, 1998.	
		...
		die Kombination von Multi-Task-Learning tiefen Lernen für die Computervision wurde 
		https://www.ijcai.org/Proceedings/2017/231 ok
		https://arxiv.org/pdf/1510.05484.pdf ok
		https://arxiv.org/pdf/1603.01249.pdf ok
		https://link.springer.com/article/10.1007/s11042-018-5609-1
		 in  eingesetzt.
