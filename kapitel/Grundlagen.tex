...
\label{chap:Grundlagen}
	...
	Vision:
	A fully automated crane unloading log trucks,
	deciding where to put the logs and feeding the
	chute.
	The crane operator is an AI instead of human
	operator.
	Artificial Intelligence must:
	- „see“ the logs, trucks, chute and environment
	- have a strategy for unloading and storing
	- make good decisions based on environmental
	factors like whether, movement, people
	Solution contains CMOS cameras, Laser Scanner,
